...
# YOUR COLLABORATION STATEMENT(s): I received assistance from Kristina Puzack on this assignment
#
#
#*****************************************
...
while True:
    ...
    if ship_X == asteroid_x and ship_Y == asteroid_y:
        #Test to see if the ship has hit an asteroid
        # STEP 1 ##########################################################
    ...
    if asteroid_y == 4:
        #Test to see if the current asteroid is at the bottom
        # STEP 2 ###########################################################
        # Write a logical expression (replace the "False") above to determine
